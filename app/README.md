...
An advanced high-performance, on-device frame extractor that converts videos into high-quality images.

---

## 📋 Terms & Conditions & Privacy Policy

These terms and conditions apply to the **Video to Photo Frame Grabber** app for mobile devices (collectively, the "Application"), together with any related services operated by **Mitch Mullvain** (the "Service Provider").
...
If you believe content violates these Terms, infringes your rights, or is unlawful, you may report it to the Service Provider at **experienceit12@gmail.com**. The report should include enough information for the Service Provider to identify the content, evaluate the complaint, and contact you if follow-up is required.
...
The Service Provider may review reported content, request additional information where necessary, remove or restrict access to content, and take action against the responsible account where appropriate. Users affected by moderation decisions may contact the Service Provider at **experienceit12@gmail.com** to request further review. The Service Provider will respond to appeals within a reasonable period and provide the reasons for any upheld moderation decision, subject to applicable law.
...
If the Application is an intermediary service as defined under the Digital Services Act (Regulation (EU) 2022/2065, "DSA"), the following provisions apply:

* **Point of Contact:** The Service Provider maintains a single point of contact for direct communication with EU authorities and recipients of the service, reachable at **experienceit12@gmail.com**. Where the Service Provider is established outside the European Union, a legal representative in the EU has been designated in accordance with Article 13 of the DSA.
...
Previous versions of these Terms and Conditions will be maintained and made available upon request by contacting the Service Provider at **experienceit12@gmail.com**.

*These terms and conditions are effective as of **2026-08-11***

### ✉️ Contact Us
If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at **experienceit12@gmail.com**.

---

## 🛠️ Log of Changes (v1.1.3)

### Version 1.1.3 (Build 4) - August 2026
* **Play Store Release Alignment:** Updated build configuration (`applicationId = "com.aistudio.videotophoto.vptxfr"`) and incremented `versionCode` to `4` for full Google Play Store production and internal testing alignment.
...
* **AdMob Readiness:** Implemented standard AdMob publisher ID setup and generated `app-ads.txt` at both app module assets and repository root for AdMob spider verification.
